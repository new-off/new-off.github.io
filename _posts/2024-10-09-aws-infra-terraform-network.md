...
>👋 안녕하세요! 저희 기술 블로그에 오신 것을 환영합니다.
>
>이곳은 저희 회사가 배우고 경험한 기술 이야기들을 공유하는 공간입니다. 소프트웨어 개발, 인프라 관리, 새로운 기술 트렌드 등 다양한 주제를 다루며, 저희가 겪은 문제와 해결 방법, 그리고 배운 것들을 기록하려고 합니다. 이를 통해 비슷한 분야에 계신 분들께 조금이나마 도움이 되기를 바랍니다.

이번 글에서는 Terraform을 사용해 AWS 인프라를 모듈화하여 손쉽게 관리하는 과정을 다뤄보려고 합니다. AWS VPC, Application Load Balancer(ALB), Route 53, ACM을 Terraform으로 모듈화하고 설치하는 과정을 단계별로 설명하겠습니다. 각 단계에서 모듈화하는 방법과 설정, 그리고 실제 인프라 구성에 대한 팁을 소개할 예정입니다. 이 글이 추후 뉴오프에 입사하게 될 동료분들께 도움이 되기를 바랍니다.

현재 뉴오프는 도메인만 있는 백지 상태의 인프라를 가지고 있습니다. 따라서 이 글은 그러한 초기 상태를 기준으로 작성되었으며, 다른 환경과 약간의 차이가 있을 수 있습니다.
